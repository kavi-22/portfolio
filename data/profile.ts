...
export const PROFILE: Profile = {
  ...
  currentlyLearning: [
    ...
    "Server Actions & App Router Optimization",
    "Docker & CI/CD Pipelines"
  ],
  lookingFor: [
    "Full-Stack Developer Roles",
    "Frontend Engineer Positions",
    "Contract / Freelance Web Engineering",
  ...
  stats: {
    projectsBuilt: "4+ Production Projects",
    yearsExperience: "1+ Years Building",
    technologies: "12+ Technologies",
    currentRole: "Open for Opportunities",
  },
  codeSnippet: {
  ...
  education: "B.Sc. Computer Science (Annamalai University)",
  grade: "First Class",
  stack: ["Next.js", "React", "TypeScript", "Tailwind"],
  status: "Available for high-impact roles",
  principles: [
    "Clean, typed code architecture",
